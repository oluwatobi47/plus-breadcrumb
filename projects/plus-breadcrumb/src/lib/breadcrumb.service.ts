...
import {PlusBreadcrumbModule} from "./breadcrumb.module";

@Injectable({
  providedIn: PlusBreadcrumbModule
})
export class BreadcrumbService {
  ...
  private routesWithCallback: Map<string, (val: string) => string> = new Map<string, (val: string) => string>();
  private routesWithCallbackRegex: Map<string, (val: string) => string> = new Map<string, (val: string) => string>();
